...
//page router
app.get('/',(req,res,next) => appRoutes.index(req,res,next,{profile : sessionstorage.getItem('profile')}))


app.get('/home',(req,res,next) => appRoutes.home(req,res,next,{profile : sessionstorage.getItem('profile')}))
app.get('/changepassword',(req,res,next) => appRoutes.changepassword(req,res,next,{profile : sessionstorage.getItem('profile')}))
app.get('/Candidate_profile',(req,res,next)=> appRoutes.Candidateprofile(req,res,next))
app.get('/Update_info',(req,res,next)=> appRoutes.Updateprofile(req,res,next))
...
app.get('/choices_available',(req,res,next) => appRoutes.choicesAvailable(req,res,next))
app.get('/filling_choices',(req,res,next) => appRoutes.fillingChoices(req,res,next))
app.get('/arrange_choice',(req,res,next) => appRoutes.arrangechoice(req,res,next))
app.get('/multiple_deletion',(req,res,next) => appRoutes.multipledeletion(req,res,next))
...
app.get('/Adminindex',(req,res,next) => appRoutes.Adminindex(req,res,next))
...
app.get('/Updateseat',(req,res,next) => appRoutes.Updateseat(req,res,next))
